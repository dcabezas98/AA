...
Pérdida logarítmica (aumentada) en la muestra: 0.0439686123874305 \\
...
$E_{cv} = 0.976982488756442$ (este valor varía entre ejecuciones).
...
Pérdida logarítmica (aumentada) en test: 0.08600667100019206 \\
...
persona que trazó el dígito, pero no ha sido el caso.
...
El MSE es mejor que el MAE porque los outliers ya han sido
normalizados
